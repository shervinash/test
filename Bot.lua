...
function tran(data)
  if not robot then
    ...
    if data.ID == "Message" then
      ...
      elseif redistg == "setrank" then
        msg = data
        msg.text = "!!!setrank:" .. msg.content_.text_
        msg.chat_id = msg.chat_id_
        msg.from_id = msg.sender_user_id_
        msg.id_ = msg.reply_to_message_id_ + 1
        msg.reload = reload
        match_plugins(msg)
        redis:set("message:tg", "non")
      else
...
function tdcli_update_callback(data)
  if not started then
    ...
    plugins = {}
    load_plugins()
    group = load_data("group.json")
  elseif not robot then
    if data.ID == "UpdateNewMessage" then
      msg = data.message_
      tg.sendMessage(msg.chat_id_, 0, 1, "\216\174\216\183\216\167!\216\177\216\168\216\167\216\170 \216\186\219\140\216\177 \217\129\216\185\216\167\217\132 \216\180\216\175\217\135 \216\167\216\179\216\170 .", 1, "html")
    end
  else
    if data.ID == "UpdateNewMessage" then
      msg = data.message_
